package de.xbrowniecodez.infinitecracker;
...
import de.xbrowniecodez.infinitecracker.api.RoundedBorder;
import de.xbrowniecodez.infinitecracker.methods.DirectLeaksMethod;
import de.xbrowniecodez.infinitecracker.methods.SpigotMethod;
	...
	private static void createGUI() {
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				InfiniteCracker.setTitle("InfiniteCracker " + version + " @xBrownieCodez");
				...
				startButton.setIcon(
						new ImageIcon(Main.class.getResource("/de/xbrowniecodez/infinitecracker/stuff/StrtBtn.png")));
				...
				image.setIcon(new ImageIcon(Main.class.getResource("/de/xbrowniecodez/infinitecracker/stuff/logo.png")));
				image.setFont(new Font("Trebuchet MS", Font.BOLD, 31));
				image.setForeground(Color.WHITE);
				image.setBounds(-30, 12, 611, 80);
				...
				selectButton.setIcon(
						new ImageIcon(Main.class.getResource("/de/xbrowniecodez/infinitecracker/stuff/SlctBtn.png")));
				...
				InfiniteCracker.setIconImage(Toolkit.getDefaultToolkit()
						.getImage(getClass().getResource("/de/xbrowniecodez/infinitecracker/stuff/icon.png")));
				...
				try {
					URLConnection urlConnection = new URL("https://api.infiniteleaks.net/backend/infinitecracker/version")
							.openConnection();
